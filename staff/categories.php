                                ...
                                if ($output && is_array($output)) {
                                    if (count($output) > 0) {
                                        foreach ($output as $row) {
                                            ...
                                            echo "<tr class=''>";
                                            echo "<td class=''>" . $row['category_id'] . "</td>";
                                            echo "<td class=''>" . $row['category_type'] . "</td>";
                                            echo "<td class=''>" . $row['category_count'] . "</td>";
                                            echo "<td class=''> <a href='#" . $row['category_id'] . "' class='btn btn-sm btn-outline-dark texts-red borders-red bi bi-pencil-square'></a> </td>";
                                            echo "</tr>";
                                        }
                                    } else {
